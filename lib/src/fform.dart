...
abstract class FForm extends ChangeNotifier {
  ...
  List<FFormField<Object?, Object?>> get fields;

  /// List of sub forms of the form.
  List<FForm> get subForms => [];

  /// List of all fields of the form.
  List<FFormField<Object?, Object?>> get _allFields => [...fields, ...subForms.expand((element) => element._allFields)];

  /// List of answers of the fields.
  List<Object?> get answerFields => fields.map((e) => e.exception).toList();
  ...
  List<Object?> get exceptionFields => answerFields.where((element) => element != null).toList();

  /// List of exceptions of the sub forms.
  List<Object?> get exceptionSubForms => answersSubForms.where((element) => element != null).toList();

  /// List of all exceptions of the fields and sub forms.
  List<Object?> get exceptions => answers.where((element) => element != null).toList();
  ...
  T get<T extends FFormField<Object?, Object>>() => fields.whereType<T>() as T;
}
